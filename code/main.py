...
def main(args):
    ...
    wandb.init(id=wandb_id, resume="allow", project=arg.project,
...
if __name__ == "__main__":
    ...
    arg('--deepconn_embed_dim', type=int, default=64,
...
def main(args):
    ...
    wandb.init(id=wandb_id, resume="allow", project=args.project,
               name=f'{args.model}_{args.timestamp}', config=config, entity=args.entity)
    ...
    submission.to_csv(
        f'{args.saved_model_path}/{args.timestamp}/{args.timestamp}_{args.model}.csv', index=False)
